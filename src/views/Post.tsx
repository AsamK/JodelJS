            ...
            >
                ...
                {post.thumbnail_url ? (
                    ...
                    <Message
                        ...
                        link={
                            post.news_url ? { title: post.news_cta, url: post.news_url } : undefined
                        }
                    />
                )}
                <Vote
                    vote_count={post.vote_count}
                    voted={post.voted ? post.voted : VoteType.NOT_VOTED}
                    upvote={this.upvote}
                ...
                {!post.poll_id ? null : (
                    <div style={{ clear: 'both' }} onClick={e => e.stopPropagation()}>
...
const mapDispatchToProps = (dispatch: JodelThunkDispatch, ownProps: IPostProps) => {
    return {
        ...
        pollVote: (pollId: string, option: number) =>
            dispatch(pollVote(ownProps.post.post_id, pollId, option)),
