...
export const channelListVisibleSelector = (state: IJodelAppStore) => state.viewState.channelList.visible;

export const settingsVisibleSelector = (state: IJodelAppStore) => state.viewState.settings.visible;

export const notificationsVisibleSelector = (state: IJodelAppStore) => state.viewState.notifications.visible;
