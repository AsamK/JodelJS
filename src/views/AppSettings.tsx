    ...
    public render(): React.ReactElement | null {
        return (
            <div className="appSettings">
                ...
                <div className="block">
                    <SelectLocation
                        useBrowserLocation={this.props.useBrowserLocation}
                            ...
                            <div>
                                <label>
                                    <input
                                        ...
                                        className="homeLink"
                                        onChange={() =>
                                            this.props.showHome(!this.props.useHomeLocation)
                                        }
                ...
                <h4>
                    Internationale/Reise Jodel{' '}
                    {!this.props.feedInternationalizable
                ...
                <div className="block">
                    <label>
                        <input
                            type="checkbox"
                            className="internationalFeedCheckbox"
                            onChange={() =>
                                this.props.setInternationalFeed(!this.props.feedInternationalized)
                            }
                ...
                <div className="block">
                    ...
                    <div className="userType">
                        <FormattedMessage id="user_type" defaultMessage="User type" />:
                        <select
                        ...
                        >
                            ...
                            <option value={UserType.HIGH_SCHOOL_GRADUATE}>
                    ...
                    <div className="userLanguage">
                        <FormattedMessage id="user_language" defaultMessage="User language" />:
                        <input
                    ...
                    <div className="pendingDeletion">
                        {this.props.pending_deletion
                            ? 'ACHTUNG: Konto ist zum löschen vorgemerkt'
                            : ''}
                    </div>
                </div>
                <button
...
const mapStateToProps = (state: IJodelAppStore): IAppSettingsStateProps => {
    return {
        ...
        feedInternationalizable: state.account.config
            ? state.account.config.feedInternationalizable
            : false,
        feedInternationalized: state.account.config
            ? state.account.config.feedInternationalized
            : false,
...
const mapDispatchToProps = (dispatch: JodelThunkDispatch): IAppSettingsDispatchProps => {
    return {
        ...
        setHome: (location: IGeoCoordinates) =>
            dispatch(setHome(location.latitude, location.longitude)),
        setInternationalFeed: (enable: boolean) => dispatch(setInternationalFeed(enable)),
        setLocation: (location: IGeoCoordinates) =>
            dispatch(setLocation(location.latitude, location.longitude)),
        setUseBrowserLocation: (useBrowserLocation: boolean) =>
            dispatch(setUseBrowserLocation(useBrowserLocation)),
