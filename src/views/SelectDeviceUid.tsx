...
export class SelectDeviceUid extends React.PureComponent<
    ISelectDeviceUidProps,
    ISelectDeviceUidState
> {
            ...
            <div className="selectDeviceUid">
                <label>
                    <input
                        type="radio"
                        value={CREATE_NEW}
                        checked={this.state.radioState === CREATE_NEW}
                ...
                <label>
                    <input
                        type="radio"
                        value={USE_EXISTING}
                        checked={this.state.radioState === USE_EXISTING}
                        onChange={this.handleChangeRadio}
                    />
                    <FormattedMessage
